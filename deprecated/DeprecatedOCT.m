classdef DeprecatedOCT < handle
    % OCT
    % 
    % Description:
    %   Old OCT class used with ChoroidIdentification for analysis of the
    %   experiments in the summer of 2018.
    %
    % Constructor:
    %   x = DeprecatedOCT(imageID, imagePath)
    %
    % Inputs:
    ...
    methods
        function obj = DeprecatedOCT(imageID, imagePath)
            % OCT  Constructor
