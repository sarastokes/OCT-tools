...
%
% Inputs:
%	ratio1 		choroid ratio or OCT object of image 1(before)
%	ratio2 		choroid ratio or OCT object of image 2 (after)
% Optional inputs:
...
% --------------------------------------------------------------------
    ...
    if isa(ratio1, 'OCT')
        ratio1 = ratio1.choroidRatio;
    end
    if isa(ratio2, 'OCT')
        ratio2 = ratio2.choroidRatio;
    end
