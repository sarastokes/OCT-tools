...
% ------------------------------------------------------------------------
    ...
    methods (Access = private)        
        ...
        function onStorePoints(obj, ~, ~)
            if ~isempty(obj.calculatedMidpoint)
        ...
        function onKeyPress(obj, ~, evt)
            switch evt.Key
                ...
                case 'rightarrow'
                    ...
                    if newValue < size(obj.octImage, 2)
    ...
    methods (Access = private)
        ...
        function plotChoroid(obj, xInd)
            ...
            if ~isempty(h)
                ...
                line([1, 255], repmat(obj.Choroid(xInd, 2), [1, 2]),...
                    'Parent', obj.histHandle,...
                    'Color', rgb('peach'),...
                    'LineWidth', 1,...
                    'Tag', 'Choroid');
    ...
    methods (Access = private)
        function createUI(obj)
            % CREATEUI  Sets up the main user interface
            ...
            obj.sliderValue = 1;  % Start at the leftmost pixel
            
            obj.createImage(mainLayout);    
            ...
            uicontrol(uiLayout,...
                'Style', 'text',...
                'String', 'Index = 1',...
                'TooltipString', 'X-axis pixel (change with arrow keys)',...
                'Tag', 'SliderText');
            uicontrol(uiLayout,...
                'Style', 'push',...
                'String', 'Find Extrema',...
            ...
            uicontrol(selectLayout,...
                'Style', 'push',...
                'String', 'Peak',...
                'TooltipString', 'Select a green peak point (''t'')',...
                'Callback', @obj.onSelectPeak);
            uicontrol(selectLayout,...
                'Style', 'push',...
                'String', 'Trough',...
                'TooltipString', 'Select a red trough point (''t'')',...
            ...
            uicontrol(uiLayout,...
                ...
                'TooltipString', 'Find midpoint between peak and trough (''m'')',...
                'Tag', 'FindMidpoint',...
        ...
        function createImage(obj, parentHandle)
            ...
            % Mark pixel currently shown in 1D histogram
        ...
        function createExportUI(obj, parentHandle)
            ...
            uicontrol(plotLayout,...
                'Style', 'push',...
                'String', 'Show',...
                'TooltipString', 'Show on image to the left (key = ''s''',...
                'Callback', @obj.onStorePoints);
            uicontrol(plotLayout,...
                'Style', 'push',...
                'String', 'Delete',...
                'TooltipString', 'Delete recently added point (key = ''d'')',...
